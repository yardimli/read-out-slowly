	...
	<div class="card mb-3" id="settingsCard">
		<div class="card-header d-flex justify-content-between align-items-center">
			<div>
				...
				<small class="ms-2 text-muted">Welcome, <?php echo htmlspecialchars(AuthHelper::getCurrentUsername()); ?>
					!</small>
			</div>
		...
		<div class="card-body">
			...
			<div class="row align-items-end mb-3">
				...
				<div class="col-md-3">
					...
					<input type="range" id="unreadTextOpacityInput" class="form-range" value="30" min="0" max="100" step="1"
					       style="max-width:70%;">
			...
			<div class="row align-items-end">
				...
				<div class="col-md-3 mb-3">
					<label for="ttsVoiceSelect" class="form-label"><i class="fas fa-microphone text-success me-1"></i>TTS
						Voice:</label>
				...
				<div class="col-md-3 mb-3" id="ttsLanguageCodeContainer">
					<label for="ttsLanguageCodeSelect" class="form-label"><i class="fas fa-language text-warning me-1"></i>TTS
						Language:</label>
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="mb-3"><label for="aiPromptInput" class="form-label">Enter your prompt for the AI:</label>
						<input type="text" class="form-control" id="aiPromptInput"
						       placeholder="e.g., Write a short lesson about cats">
					</div>
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-success" id="useAiTextBtn" disabled><i class="fas fa-check-circle"></i>
						Use This Text
					</button>
				</div>
			</div>
